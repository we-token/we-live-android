...
public final class ObjectCache {
     ...
     * @throws java.io.IOException 创建目录异常
     */
    ...
    public synchronized long getLastCacheTime(String key) {
        Map<String, Long> updateTimeMap = (Map<String, Long>) getSerializableObject(CacheObjectKey.LAST_CACHE_TIME);
    ...
    private void setLastUpdateTime(String key) {
        ...
        mSerializableLruCache.put(CacheObjectKey.LAST_CACHE_TIME, entity);
        synchronized (mSaveObjectThread) {
            mSaveObjectThread.addObject(CacheObjectKey.LAST_CACHE_TIME, entity);
            mSaveObjectThread.notify();
        }
    }

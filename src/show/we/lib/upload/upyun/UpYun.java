package show.we.lib.upload.upyun;
...
public class UpYun {
    ...
    public static final String HOST = "b0.upaiyun.com";
    /**
    ...
    // 待上传文件的"访问密钥"
    public static final String FILE_SECRET = null;
    //空间名
    ...
    public static final String FILE_BUCKET_NAME = "showmp3";
    public static final String ACCUSE_PHOTO = "showaccuse";

    private AtomicInteger mUploadLength = new AtomicInteger(0);

    public UpYun(String bucketName) {
        this.bucketName = bucketName;
    }

    public AtomicInteger getUploadedLength() {
    ...
    public String writeFile(String remoteFilePath, String localFilePath, String apiDomain, String date, String authorization) throws IOException {
        File mLocalFile = new File(localFilePath);
        if (mLocalFile.isFile()) {
            return writeFile(remoteFilePath, mLocalFile, apiDomain, date, authorization, false, null);
        } else {
            return null;
        }
    }
     ...
     */
    public String writeFile(String filePath, File file, String apiDomain, String date, String authorization) throws IOException {

        return writeFile(filePath, file, apiDomain, date, authorization, true, null);
    }
     ...
     * @throws java.io.IOException
     */
    public String writeFile(String filePath, File file, String apiDomain, String date, String authorization, boolean auto)
            throws IOException {

        return writeFile(filePath, file, apiDomain, date, authorization, auto, null);
    }
    ...
    public String writeFile(String filePath, File file, String apiDomain, String date, String authorization, boolean auto,
        ...
        try {
            ...
            // 设置文件的访问密钥
            if (!isEmpty(this.FILE_SECRET)) {
                conn.setRequestProperty(CONTENT_SECRET, this.FILE_SECRET);
            }
            ...
            while ((temp = is.read(data)) != -1) {
                ...
                mUploadLength.set(mUploadLength.get() + temp);
            }

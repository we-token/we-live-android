    ...
    public static final class SetupWizard {
        ...
        public void setup(PullToRefreshLayout pullToRefreshLayout) {
            PullToRefreshAttacher attacher = pullToRefreshLayout.createPullToRefreshAttacher(
                    mActivity, mOptions);
            if (mActivity instanceof PullToRefreshAttacher.OnPullToRefreshAttacherEventListener) {
                ((PullToRefreshAttacher.OnPullToRefreshAttacherEventListener) mActivity).onAddAttacher(attacher);
            }

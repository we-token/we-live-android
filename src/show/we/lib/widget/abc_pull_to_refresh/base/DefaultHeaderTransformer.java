...
import show.we.lib.widget.abc_pull_to_refresh.sdk.Compat;
import show.we.lib.widget.abc_pull_to_refresh.smoothprogressbar.SmoothProgressBar;
import show.we.lib.widget.abc_pull_to_refresh.smoothprogressbar.SmoothProgressDrawable;
...
public class DefaultHeaderTransformer extends HeaderTransformer {
    ...
    public void onViewCreated(Activity activity, View headerView) {
        ...
        onReset();
        sharedpreferences = activity.getSharedPreferences("isOpenLeftMenu",
    ...
    public void onReset() {
        ...
        if (mContentLayout != null) {
        	sharedpreferences = mHeaderView.getContext().getSharedPreferences("isOpenLeftMenu",
   				 Activity.MODE_PRIVATE); 
        	if(sharedpreferences.getString("isOpen", "") == "0"){
    ...
    @Override
    public void hideHeaderViewImmediately() {
        final boolean changeVis = mHeaderView.getVisibility() != View.INVISIBLE;
        if (changeVis) {
...
//        Drawable bg = .getResources().getDrawable(R.drawable.title_bar);
//        if (bg != null) {
            mHeaderTextView.setBackgroundResource(R.drawable.title_bar);

...
public abstract class HeaderTransformer {
     ...
     * to that provided from {@link show.we.lib.widget.abc_pull_to_refresh.listeners.OnRefreshListener} but is more suitable
    ...
    public abstract void hideHeaderViewImmediately();

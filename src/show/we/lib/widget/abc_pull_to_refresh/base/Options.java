...
public final class Options {
    ...
    private static final int DEFAULT_HEADER_LAYOUT = R.layout.abc_default_header;
    private static final int DEFAULT_HEADER_ID = R.id.ptr_header;
    private static final float DEFAULT_REFRESH_SCROLL_DISTANCE = 0.5f;
    private static final boolean DEFAULT_REFRESH_ON_UP = false;
    private static final int DEFAULT_REFRESH_MINIMIZED_DELAY = 200;
    public static final int DEFAULT_REFRESH_MINIMIZED_INTERVAL = 1 * 1000;
    private static final int DEFAULT_REFRESH_TIMEOUT_DURATION = 20 * 1000;
    ...
    int headerId = DEFAULT_HEADER_ID;
    ...
    long refreshMinimizeInterval = DEFAULT_REFRESH_MINIMIZED_INTERVAL;
    long refreshTimeoutDuration = DEFAULT_REFRESH_TIMEOUT_DURATION;
